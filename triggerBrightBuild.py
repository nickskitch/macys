...
j.build_job('MCOM_Dev_WishList', {'daServiceAccountUser': 'da-MCOM-WDSDevOps', 'daServiceAccountPasswd': '', 'targetEnv': 'mcominternal5024', 'project': 'Wishlist', 'tags': '@'+ BRANCH, 'gitBranch': 'master'})
